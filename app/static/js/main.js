...
(function() {
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    const contactEndpoint = contactForm ? contactForm.getAttribute('data-action') || '/contact/submit' : null;
    if (contactForm) {
      contactForm.addEventListener('submit', function(e) {
        ...
        const subject = this.querySelector('[name="subject"], [name="messageTitle"]')?.value?.trim();
        ...
        .then(function(data) {
          if (contactStatus) {
            ...
            contactStatus.style.color = data.success ? '#10b981' : '#ef4444';
          }
